...
import static com.pedrolima.wexchange.integration.fiscal.builders.ApiUrlBuilder.FieldType.EFFECTIVE_DATE;
import static com.pedrolima.wexchange.integration.fiscal.builders.ApiUrlBuilder.FieldType.EXCHANGE_RATE;
import static com.pedrolima.wexchange.integration.fiscal.builders.ApiUrlBuilder.PageType.SIZE;
import static com.pedrolima.wexchange.integration.fiscal.builders.ApiUrlBuilder.ParamComparator.GTE;
import static com.pedrolima.wexchange.integration.fiscal.builders.ApiUrlBuilder.ParamComparator.IN;
import static com.pedrolima.wexchange.integration.fiscal.builders.ApiUrlBuilder.ParamComparator.LTE;
import static com.pedrolima.wexchange.integration.fiscal.builders.ApiUrlBuilder.SortOrder.ASC;
import static com.pedrolima.wexchange.integration.fiscal.builders.ApiUrlBuilder.SortOrder.DESC;
